...
<div class="w-full h-[90%] flex flex-col items-center justify-center">
    <div class="w-full flex items-center justify-between space-x-6 text-[16px]">
      <div class="w-[40%] h-[80%] rounded-[10px] p-4 shadow">
      ...
      <form method="post" class="w-[60%] h-[80%] flex flex-col items-center justify-start p-4 bg-[#FFE9F5] rounded-[12px]" on:submit={handleSubmit}>
        <div class="w-full space-x-1 flex items-center justify-start font-semibold text-[#DA478D] mb-5">
          <span>JOB FORM</span>
        </div>
        ...
        <div class="relative w-full mt-2">
          <textarea placeholder="Description" class="w-full h-[400px] rounded-[10px] p-4 border-2 border-transparent hover:bg-[#FFF7F7] break-words overflow-auto resize-none" required bind:value={description}></textarea>
          <span class="absolute -top-1 -right-1 z-1"><Asterisk size={12} weight="bold" color="#DA478D" /></span>
        </div>
